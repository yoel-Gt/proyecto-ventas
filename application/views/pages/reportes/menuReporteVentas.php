...
<ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
           <li class="nav-item has-treeview menu-close">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?php echo base_url(); ?>ctrlMenus/productoNuevo" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Nuevo v1</p>
                </a>
              </li>
              ...
              <li class="nav-item">
                <a href="<?php echo base_url(); ?>ctrlMenus/productoPromociones" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Promociones</p>
                </a>
              </li>
...
<ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
           <li class="nav-item has-treeview menu-close">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="<?php echo base_url(); ?>ctrlMenus/cortesDelDia" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
...
<ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
           <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?php echo base_url(); ?>ctrlMenus/reportesVentas" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
